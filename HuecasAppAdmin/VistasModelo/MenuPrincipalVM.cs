...
{
    internal class MenuPrincipalVM : BaseVM
    {
        #region Constructor
        public MenuPrincipalVM(INavigation navegacion)
        {
        ...
        public async Task NavMenuConfigProces()
        {
        ...
        public ICommand NavMenuConfigComand => new Command(async () => await NavMenuConfigProces());
